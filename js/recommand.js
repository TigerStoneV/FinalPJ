...
function setInformationTop5(shopData) {
	...
	if(count < 5){
		...
		addHtml += 	        "<span id='info_star'>"+ shopData[i].score +"</span><br>";
...
function setInformationSlider(shopData) {
	...
	for(let i = 0; i < count; i++) {
		...
		if(btnCount1 <= dataLength){
		    ...
		    addHtml +=       	 '<div class="remain_info_star">'+ shopData[arrCount1].score +'</div>';
		    addHtml +=        	 '<div class="remain_info_category">'+ shopData[arrCount1].category2 +'</div>';
		    addHtml +=       	 '<div class="remain_info_address">'+ shopData[arrCount1].menu +'</div>';
		    addHtml +=   	  '</div>';
		    addHtml +=	'</div>';
		    if(btnCount2 <= dataLength){
			    ...
			    addHtml +=       	 '<div class="remain_info_star">'+ shopData[arrCount2].score +'</div>';
			    addHtml +=       	 '<div class="remain_info_category">'+ shopData[arrCount2].category2 +'</div>';
			    addHtml +=       	 '<div class="remain_info_address">'+ shopData[arrCount2].menu +'</div>';
			    addHtml +=   	'</div>';
			    addHtml +=	'</div>';
				addHtml +=	'</div>';
			}
